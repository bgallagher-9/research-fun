...
describe('Array and Loop Challenge ', function() {
  ...
  challenge('Implement this function that takes an array and returns all the strings longer than four letters.', function() {
  ...
  challenge('Implement this function that takes an array and a length and returns all the strings longer than that length.', function() {
    var strings = ['nachos', 'steak', 'carp', 'soy', 'chicken'];
